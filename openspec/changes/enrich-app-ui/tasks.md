...
- [ ] 2.3 Verify create, edit, delete and (for bags) default-contents management still work on both surfaces at mobile and desktop widths
...
- [ ] 3.3 Verify create, edit and delete (trips) and copy, regenerate and revoke (shared links) still work at mobile and desktop widths
...
- [ ] 4.5 Verify add-from-library, add one-off, assign-to-bag, With Me, packed toggle, quantity change, reorder and delete still work at mobile and desktop widths
...
- [ ] 6.5 Verify every surface at mobile and desktop widths with no horizontal overflow and all navigation and actions reachable

## 7. Verification

- [x] 7.1 Verify `npm run verify` passes, including the bundle check and static export
- [ ] 7.2 Update the end-to-end tests for the new surfaces and verify `npm run test:e2e` passes at mobile and desktop widths
