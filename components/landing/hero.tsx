...
import { AnimatedTooltip } from "@/components/landing/ui/animated-tooltip";
import { Star } from "@/components/landing/custom/star";

const Hero = () => {
  const { resolvedTheme } = useTheme();
  const mounted = useIsMounted();
  const rotatingWords = ["Trips", "Adventures", "Journeys"];
    ...
    >
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center max-w-5xl mx-auto">
          ...
          >
            Build reusable bags and items once, then pack them into a list for any trip. Know what
            you are bringing, and where it is.
          </motion.p>
