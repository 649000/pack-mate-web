  ...
  const features = [
    {
      ...
      description:
        "Save the things you take on every trip. Add an item or a bag once, then reuse it whenever you pack again.",
      stats: "Reusable",
      metric: "Items and bags",
      colors: {
    ...
    },
    {
      ...
      title: "With Me",
      description:
        "Passport, wallet, phone. Mark what you carry yourself, kept separate from what goes inside a bag.",
      stats: "Nothing",
      metric: "Left behind",
      colors: {
    ...
    <section id="features" className="py-24 bg-background border-b border-border/50">
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <CustomTitle>Everything you need to pack</CustomTitle>

          <CustomSubtitle>
            Reusable bags and items, a clear place for everything, and progress you can see. Simple
            by default, fast to use.
          </CustomSubtitle>
        </motion.div>
